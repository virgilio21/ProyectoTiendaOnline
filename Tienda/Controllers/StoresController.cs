...
namespace Tienda.Controllers
{
    public class StoresController : Controller
    {
        ...
        {
            var stores = db.Stores.Include(s => s.Input);
        ...
        {
            ViewBag.InputId = new SelectList(db.Inputs, "Id", "DateIn");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Amount,Max,Min,PriceStore,InputId")] Store store)
        {
            if (ModelState.IsValid)
            {
