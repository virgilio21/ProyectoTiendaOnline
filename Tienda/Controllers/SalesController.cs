...
namespace Tienda.Controllers
{
    public class SalesController : Controller
    {
        ...
        {
            var sales = db.Sales.Include(s => s.Output).Include(s => s.User);
        ...
        {
            ViewBag.OutputId = new SelectList(db.Outputs, "Id", "DateOut");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PriceTotal,Date,Amount,UserId,OutputId")] Sale sale)
        {
            if (ModelState.IsValid)
            {
